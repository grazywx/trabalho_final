...
<div class="container" >
	 <div class="card">
		...
		<form class="card-form" action="{{ route('consultas.destroy',['consulta' => $consulta->id]) }}" method="post" enctype="multipart/form-data">
            @csrf
			...
			<div class="action">
				<button type="submit" class="action-button">Cancelar Agendamento</button>
			</div>
